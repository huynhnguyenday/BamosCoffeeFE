  ...
  const updateNewsletterCheckbox = async (id, checkbox) => {
    try {
      const response = await axios.put(
        `https://bamosbe.com/api/newsletters/${id}`,
        { checkbox },
      );
  ...
  const fetchValidCoupons = async () => {
    try {
      const response = await axios.get(
        "https://bamosbe.com/api/coupons/valid-coupons",
      );
      if (response.data.success) {
  ...
  const handleSendCoupon = async () => {
    ...
    try {
      ...
      const response = await axios.post(
        "https://bamosbe.com/api/coupons/send-coupon",
        {
      ...
      if (response.data.success) {
        ...
        const deletePromises = newsletters
          ...
          .map((newsletter) =>
            axios.delete(
              `https://bamosbe.com/api/newsletters/${newsletter._id}`,
            ),
          );
